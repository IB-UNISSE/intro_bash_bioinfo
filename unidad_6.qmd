...
Los **bucles** permiten repetir una acción varias veces, lo que resulta muy útil cuando se trabaja con múltiples archivos o muestras.
...
Este tipo de bucle es muy útil cuando se quiere aplicar el mismo comando a muchos archivos.
...
Este bucle se ejecuta mientras una condición siga siendo verdadera.
