...
Una nomenclatura adecuada debe:

-   Ser consistente a lo largo del proyecto.

-   Evitar espacios, acentos y caracteres especiales.

-   Utilizar guiones bajos (`_`) o guiones medios (`-`).

-   Incluir información relevante como fecha, muestra, versión o etapa del análisis.
...
> No es necesario agregar contenido adicional dentro de `unidad_2` en esta práctica.
...
-   El `README.md` debe incluir brevemente:
